...
Report bugs at <https://github.com/Jordan-Pierce/CoralNet-Toolbox/issues>.
...
3.  The pull request should work for Python 3.8 and later, and
    for PyPy. Check <https://github.com/Jordan-Pierce/CoralNet-Toolbox/pull_requests> and make sure that the tests pass for all
