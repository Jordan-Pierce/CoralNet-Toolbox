...
class Segment(Base):
    ...
    def setup_dataset_layout(self):
        ...
        self.model_edit.setToolTip("Path to a trained segmentation model (.pt file).")
        ...
        self.dataset_edit.setToolTip("Path to segmentation dataset YAML file for evaluation.\nYAML should define path to test set and class names.")
