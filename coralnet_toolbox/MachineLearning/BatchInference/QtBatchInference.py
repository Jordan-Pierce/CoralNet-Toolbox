...
class BatchInferenceWorker(QThread):
    ...
    def __init__(self, model, items, initial_thresholds,
        ...
        #     (e.g. visual_prompts=[] for YOLOE, quantize=False for MobileSAM).
    ...
    def _warmup_model(self):
        ...
        try:
            kwargs = dict(device=self.device, quantize=True, verbose=False)
    ...
    def run(self):
        ...
        try:
            ...
            while i < total:
                ...
                # MobileSAM quantize=False, segment-task retina_masks).
