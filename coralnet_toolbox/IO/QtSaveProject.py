...
class SaveProject(QDialog):
    ...
    def setup_save_layout(self):
        ...
        self.file_path_edit.setToolTip("Path where the project will be saved.\nSupports .bin (binary) and .json (JSON) formats.\nDefault: .bin if no extension provided.")
        self.browse_button.setToolTip("Browse for a save location.")
    ...
    def setup_buttons_layout(self):
        ...
        self.save_button.setToolTip("Save the project with all annotations to the specified file.\nWill overwrite existing files at this location.")
        self.cancel_button = QPushButton("Cancel")
        self.cancel_button.clicked.connect(self.reject)
        self.cancel_button.setToolTip("Close this dialog without saving.")
