...
class DropperTool3D(Tool3D):
    ...
    def _resolve_label_from_class_id(self, class_id: int):
        ...
        # Primary path: the active mask annotation's class -> label registry.
        try:
        ...
        # Fallback: the propagation engine's mesh class -> label-id registry,
        # resolved against the LabelWindow's labels.
        try:
            ...
            if label_id is not None:
                label_window = self.mvat_manager.main_window.label_window
