"""
Frustum geometry and batch actor management for MVAT.

Contains:
- Frustum: single camera frustum geometry and VTK actor
- BatchedFrustumManager: manages all frustum actors in the plotter
"""
...
# ---------------------------------------------------------------------------
# BatchedFrustumManager (inlined from former FrustumManager.py)
# ---------------------------------------------------------------------------
from typing import Dict, List, Optional, Tuple
